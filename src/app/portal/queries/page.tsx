...
const NotiticationInscription = () => {
  return <div className='xl:h-[100dvh] bg-gradient-to-b from-gray-50 via-slate-100/90 to-gray-100 flex items-center justify-center col-span-2'>
...
const QueryHistory = ({ queriesList }: { queriesList: IQueryProp[] }) => {
  return <nav className='flex flex-col gap-5 col-span-3 max-w-xl mx-auto w-full '>
